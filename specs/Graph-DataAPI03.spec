Ambient-temperature Graph Data API
=====================
...
----------------
    ...
    * Get data from kraydel database ambient-temperature Graph Data API <elderId>
    * Validate ambient-temperature Graph Data API