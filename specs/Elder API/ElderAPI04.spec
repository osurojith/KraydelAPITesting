...
=====================
    ...
    |-----------|--------------|--------|-------------|-------------|-----------|-------|------|------------------|--------|----------------|------|-----------|----------|-----------|----------|----------|------|------|-----------|----------|-----------|---------|-------------|-------------|---------|-----------------|-----------|
    |ELDER-10/11|darshana      |letmein |OK           |200          |20000      |v1     |ACTIVE|TestFirstDUPLICATE|TestLast|test79@gmail.com|M     |1          |1         |2017-12-07 |10524     |456       |AAA   |1     |PRIMARY    |1         |0112654659 |PRIMARY  |0            |1            |1        |ASSIGNED         |ACTIVE     |
