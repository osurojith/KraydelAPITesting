...
public class RoleAPI02Steps extends BaseClass {
    ...
    @Step("User enter Role API Get Elder Roles <http://ec2-52-212-72-231.eu-west-1.compute.amazonaws.com:8080/kraydel-server/api/><version></roles/elder-roles/partial>")
